...
//import core.allure.AllureLogger;
import core.utils.LocatorParser;
...
import static com.codeborne.selenide.Selenide.$$;
import static core.utils.Constants.SEARCH_TEXT;
...
public class PageTools  {
    ...
    protected  void insertText(By by, Object... args){
        $(by).shouldBe(Condition.enabled).sendKeys(SEARCH_TEXT);
    }
